...
export const calculatePrice = async (req, res) => {
  try {
    ...
    const {
      ...
      optionalCharges: rawOptionalCharges = [],
    } = req.body;
    const optionalCharges = Array.isArray(rawOptionalCharges)
      ? rawOptionalCharges.filter(k => typeof k === 'string')
      : [];
    if (optionalCharges.length) console.log(`[OPTIONAL CHARGES] Received:`, optionalCharges);
